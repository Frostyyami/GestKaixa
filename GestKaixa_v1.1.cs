...
namespace GestKaixa
{
    ...
    // --------------------------------------------------------
    //  OPERACIONS ADMINISTRADOR (NOU v1.1)
    // --------------------------------------------------------
    static class AdminOps
    {
        // ── Registre de nous usuaris (NOU v1.1) ──────────────
        ...
        // ── Obertura de nous comptes (NOU v1.1) ───────────────
        ...
        // ── Assignació d'usuaris a comptes (NOU v1.1) ─────────
    ...
    static class Menus
    {
        public static void MenuClient(UsuariSessio sessio)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine($"\n  \x1b[1mGestKaixa v1.1 — {sessio.Username}\x1b[0m");
                UI.Separador();
        ...
        public static void MenuAdmin(UsuariSessio sessio)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine($"\n  \x1b[1mGestKaixa v1.1 — Administrador ({sessio.Username})\x1b[0m");
                UI.Separador();
    ...
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("\n  \x1b[1m\x1b[36m╔══════════════════════════╗");
            Console.WriteLine("  ║    GestKaixa  v1.1       ║");
            Console.WriteLine("  ╚══════════════════════════╝\x1b[0m\n");

            // ── 1. Connexió a la base de dades ───────────────
            try
            {
                using var _ = DB.Connect();
                UI.Ok("Connexió a la base de dades establerta.");
            }
            catch (Exception ex)
            {
            ...
            // ── 2. Login d'usuaris (màxim 3 intents) ─────────
