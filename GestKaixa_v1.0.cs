...
// ============================================================
//  GestKaixa — Aplicació de gestió bancària simplificada
//  Versió 1.0
...
namespace GestKaixa
{
    ...
    static class ClientOps
    {
        ...
        {
            UI.Titol("Fer un ingres");
            int compteId = SeleccionarCompte(usuariId);
            if (compteId < 0) return;

            decimal import = UI.DemanarImport("Import de l'ingres");
            if (import <= 0) return;
        ...
        static int SeleccionarCompte(int usuariId)
        {
            ...
            if (ok == 0) { UI.Error("Compte no valid."); return -1; }
            return id;
        }
        ...
        static void RegistrarMoviment(int compteId, decimal import, string concepte)
        {
            ...
            {
                UI.Error("Operacio rebutjada: " + ex.Message);
            }
        }
    }
        ...
        public static void MenuClient(UsuariSessio sessio)
        {
            ...
            while (actiu)
            {
                ...
                switch (Console.ReadLine()?.Trim())
                {
                    ...
                    default:  UI.Error("Opcio no valida.");        UI.Pausa(); break;
                }
            }
        }
    }
    ...
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("\n  \x1b[1m\x1b[36m+==========================+");
            Console.WriteLine("  ||    GestKaixa  v1.0     ||");
            ...
            {
                Console.WriteLine("\n  \x1b[31mx No s'ha pogut connectar a la base de dades.\x1b[0m");
            ...
            for (int intent = 0; intent < 3; intent++)
            {
                ...
                string pass = UI.LlegirPassword("Password");
            ...
            if (sessio == null)
            {
                UI.Error("Massa intents fallits. Acces denegat.");
                return;
            }
            ...
            // ── 3. Menu client (v1.0 nomes client, admin per versions futures)
